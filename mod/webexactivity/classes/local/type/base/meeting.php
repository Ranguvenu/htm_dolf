...
class meeting {
    ...
    public function save_to_webex() {
        ...
        try {
            ...
            $meetingid = $response['meet:meetingUUID'][0]['#'];

            $webexdata = [];
            $webexdata['id'] = $meetingid;
            $webexdata['meetid '] = $response['meet:meetingUUID'][0]['#'];

            $samplecode = meeting::get_participants($meetingid);
    ...
    function get_participants($meetingid){
