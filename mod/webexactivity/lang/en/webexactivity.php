...
$string['concurrent_meetings'] = 'Concurrent Meetings';

$string['apisettings'] = 'API Settings';
$string['apiusername'] = 'WebEx Admin username';
$string['host_concurrent_meetings'] = 'Number of concurrent meetings can be host at a time';
...
$string['useraccountisnotactive'] = 'Activation mail has been sent. Check your mail.';
$string['tokenisnotvalid'] = 'Not a valid one';
...
$string['starttp'] = 'Start Training Program';
$string['startevent'] = 'Start Event';


$string['clientid'] = 'Client ID';
$string['clientsecretkey'] = 'Client Secret Key';
$string['clientsecretkey_help'] = 'Find Secret Key In API App';
$string['clientid_help'] = 'Find Client ID In API App';

$string['checkyourmail'] = 'This user is currently inactive. An activation email has been sent. Please check your email.';
$string['token_error'] = '<div class="alert alert-danger"> {$a} ';
