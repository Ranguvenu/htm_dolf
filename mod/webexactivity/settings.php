...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('webexactivity/prefix', get_string('prefix', 'mod_webexactivity'),
            ...
            $settings->add(new admin_setting_configtext('webexactivity/clientid', get_string('clientid', 'mod_webexactivity'),
            get_string('clientid_help', 'mod_webexactivity'), ''));
        $settings->add(new admin_setting_configtext('webexactivity/clientsecretkey', get_string('clientsecretkey', 'mod_webexactivity'),
            get_string('clientsecretkey_help', 'mod_webexactivity'), ''));

    $settings->add(new admin_setting_configtext('mod_webexactivity/concurrentmeeting', get_string('concurrent_meetings', 'mod_webexactivity'),
            get_string('host_concurrent_meetings', 'mod_webexactivity'), '', PARAM_INT));
