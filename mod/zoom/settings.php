...
if ($ADMIN->fulltree) {
    ...
    $settings->add($apiidentifier);
        ...
        $settings->add(new admin_setting_configtext('mod_zoom/concurrentmeeting', get_string('concurrent_meetings', 'mod_zoom'),
        get_string('host_concurrent_meetings', 'mod_zoom'), '', PARAM_INT));
