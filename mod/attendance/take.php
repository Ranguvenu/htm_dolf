...
$PAGE->set_title($course->shortname. ": ".format_string($att->name,FORMAT_HTML));
$PAGE->set_heading($course->fullname);
$PAGE->set_cacheable(true);
$PAGE->navbar->add(format_string($att->name,FORMAT_HTML));
...
echo $output->header();
echo $output->heading(get_string('attendanceforthecourse', 'attendance').' :: ' .format_string($course->fullname,FORMAT_HTML));
