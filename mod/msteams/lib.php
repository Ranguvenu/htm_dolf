 ...
 */
function msteams_add_instance(stdClass $data, mod_msteams_mod_form $mform= null) {
    global $CFG, $DB;
 ...
 * @return bool true
 */
function msteams_update_instance(stdClass $data, mod_msteams_mod_form $mform= null) {
    global $CFG, $DB;
