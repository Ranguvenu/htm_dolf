...
if ($id == -1) {
    // Creating new user.
    // Vinod Kumar - Restricted to do not add users through site administration - Starts//
    redirect($CFG->wwwroot . '/local/userapproval/index.php');
    // Vinod Kumar -  Restricted to do not add users through site administration  - Ends//
    $user = new stdClass();
    $user->id = -1;
    $user->auth = 'manual';
    $user->confirmed = 1;
