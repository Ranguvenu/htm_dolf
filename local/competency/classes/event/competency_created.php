...
class competency_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcompetencycreation', 'local_competency');
    }

    public function get_description() {
        return "The user with id {$this->userid} Competency created  with id {$this->objectid}.";
    }
