...
class competency_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcompetencyupdation', 'local_competency');
    }

    public function get_description() {
        return "The user with id {$this->userid} Competency Updated  with id {$this->objectid}.";
    }
