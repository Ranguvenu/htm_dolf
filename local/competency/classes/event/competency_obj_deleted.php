...
class competency_obj_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventcompetencyobjdeletion', 'local_competency');
    }

    public function get_description() {
        return "The user with id {$this->userid} Competency Mapping objective Deleted  with id {$this->objectid}.";
    }
