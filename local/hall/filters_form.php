...
class filters_form extends moodleform {
    function definition() {
        ...
        if($action === 'examuser_enrolment'){
            ...
            $buttonarray[] = &$mform->createElement('submit', 'filter_apply', get_string('apply','local_hall'), $applyclassarray);
            $buttonarray[] = &$mform->createElement('cancel', 'cancel', get_string('reset','local_hall'), $applyclassarray);
        }else{
            $buttonarray = array();
            ...
            $buttonarray[] = &$mform->createElement('button', 'filter_apply', get_string('apply','local_hall'), $applyclassarray);
            $buttonarray[] = &$mform->createElement('button', 'cancel', get_string('reset','local_hall'), $cancelclassarray);
        }
