...
class grievance_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'local_exam_grievance';
    }
    ...
    public function get_description() {
        global $DB;
        return "Grievance has been created"; 
    ...
    public static function get_name() {
        return get_string('grievancecreation', 'local_exams');
    }
