...
class profilefields_validation extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        global $DB;
       return "{$this->other['name']}  which entered on excel line number- {$this->objectid}";
    ...
    public static function get_name() {
        return get_string('field_validation', 'local_exams');
    }
