...
class orgoff_refundlogs_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public static function get_name() {
        return get_string('tpofferingscreationevent', 'local_trainingprogram');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/local/traininprogram/index.php');
        return $url;
    }
