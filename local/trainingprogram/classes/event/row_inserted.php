...
class row_inserted extends \core\event\base {
    ...
    public function get_description() {
      ...
      // return "{$this->other['name']} is already exist which entered on excel line number- {$this->objectid}";
        return "An offering is added for Trainingprogram -{$this->other['name']}.";
    ...
    public static function get_name() {
        return get_string('offering_added', 'local_trainingprogram');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/local/trainingprogram/index.php');
        return $url;
    }
