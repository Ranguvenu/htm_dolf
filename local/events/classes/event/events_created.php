...
class events_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        global $DB;
        return "The user with id {$this->userid} is created a event with eventid {$this->objectid}";
    ...
    public static function get_name() {
        return get_string('eventcreationevent', 'local_events');
    }
