...
class events_updated extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id {$this->userid} is updated a event with event id {$this->objectid}.";         
    }
    ...
    public static function get_name() {
        return get_string('eventsupdateevent', 'local_events');
    }
