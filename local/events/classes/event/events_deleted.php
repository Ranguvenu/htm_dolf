...
class events_deleted extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        global $DB;
        return "The user with id {$this->userid} is deleted a event with event id {$this->objectid}";    
    }
    ...
    public static function get_name() {
        return get_string('eventsdeletedevent', 'local_events');
    }
