 ...
 */
namespace local_events\event;

defined('MOODLE_INTERNAL') || die();

class events_completions extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'local_events';
    }
    ...
    public function get_description() {
        global $DB;
        return "The user with id {$this->userid} is completed a event with eventid {$this->objectid}";
        ...
        // return "The '$firstname' has been updated"; 
    ...
    public static function get_name() {
        return get_string('eventcompletionevent', 'local_events');
    }
    ...
    public function get_url() {
        global $DB;
        $url = new \moodle_url('/local/events/index.php');
        return $url;
    }
