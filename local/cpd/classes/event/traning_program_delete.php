...
class traning_program_delete extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('traning_program_delete', 'local_cpd');
    }

    public function get_description() {
        return "The user with id {$this->userid} the the program. Traning program id {$this->objectid}.";
    }
