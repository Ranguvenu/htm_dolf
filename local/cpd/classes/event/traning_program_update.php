...
class traning_program_update extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('traning_program_update', 'local_cpd');
    }

    public function get_description() {
        return "The user with id {$this->userid} updated the traning program with id {$this->objectid}.";
    }
