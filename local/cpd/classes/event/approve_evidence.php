...
class approve_evidence extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('evidence_approved', 'local_cpd');
    }

    public function get_description() {
        return "The user with id {$this->userid} approved the evidence. Evidence id {$this->objectid}";
    }
