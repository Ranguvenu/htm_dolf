...
class cpd_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('update_cpd', 'local_cpd');
    }

    public function get_description() {
        return "The user with id {$this->userid} updated the cpd. cpd id {$this->objectid}";
    }
