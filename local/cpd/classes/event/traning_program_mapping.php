...
class traning_program_mapping extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('traning_program_mapping', 'local_cpd');
    }

    public function get_description() {
        return "The user with id {$this->userid} mapped the program. Mapping id {$this->objectid}.";
    }
