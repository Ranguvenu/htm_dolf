...
class cpd_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('delete_cpd', 'local_cpd');
    }

    public function get_description() {
        return "The user with id {$this->userid} deleted the cpd. cpd id {$this->objectid}. ";
    }
