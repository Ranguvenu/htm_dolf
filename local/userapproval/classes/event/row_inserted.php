 ...
 * 
 */
namespace local_userapproval\event;
defined('MOODLE_INTERNAL') || die();

class row_inserted extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'local_userapproval';
    }
    /**
    ...
    public function get_description() {
        global $DB;
      // return "{$this->other['name']} is already exist which entered on excel line number- {$this->objectid}";
        return "The user with username- {$this->other['username']} and name - {$this->other['name']} is inserted.";
    ...
    public static function get_name() {
        return get_string('user_inserted', 'local_userapproval');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/local/userapproval/index.php');
        return $url;
    }
