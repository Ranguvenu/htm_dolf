 ...
 * 
 */
namespace local_organization\event;
...
class row_inserted extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'local_organization';
    }
    /**
    ...
    public function get_description() {
        global $DB;
       //return "A sector is uploaded via sector upload";
       return "{$this->other['name']} organization is added using bulk upload.";
    ...
    public static function get_name() {
        return get_string('sector_inserted', 'local_organization');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/local/organization/index.php');
        return $url;
    }
