...
class header_missing extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        global $DB;
       return "{$this->other['name']} column header is missing in exel sheet.";
    ...
    public static function get_name() {
        return get_string('header_missing', 'local_organization');
    }
