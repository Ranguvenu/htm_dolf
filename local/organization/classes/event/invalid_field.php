...
class invalid_field extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        global $DB;
       return "{$this->other['name']} is invalid on excel line number- {$this->objectid}";
    ...
    public static function get_name() {
        return get_string('invalid_field', 'local_organization');
    }
