...
use core\task;
// use local_events\notification_emails;
class cisiupdateperson extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('cisiupdateperson', 'local_lmsws');
    }
    ...
    public function execute() {
       ...
       $accessToken = (new \local_lmsws\lib)->authentication_token($authsignin);
        $updatepersonresponse = (new \local_lmsws\lib)->updateperson($accessToken,$email,$lastname,$firstname,$cisiuserid,$dateofbirth);
        }
    }
}
