...
class row_inserted extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'local_sector';
    }
    /**
    ...
    public function get_description() {
       ...
       //return "A sector is uploaded via sector upload";
        return "A {$this->other['family']} named {$this->other['name']} is added via sector upload.";
    ...
    public static function get_name() {
        return get_string('sector_inserted', 'local_sector');
    }
    ...
    public function get_url() {
        ...
        $url = new \moodle_url('/local/sector/index.php');
        return $url;
    }
