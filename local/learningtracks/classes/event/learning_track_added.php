...
class learning_track_added extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        global $DB;
        return "The user with id {$this->userid} is added leaning track with track id {$this->objectid}.";
    }
    ...
    public static function get_name() {
        return get_string('add_learning_track', 'local_learningtracks');
    }
