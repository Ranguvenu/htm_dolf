...
class learning_track_deleted extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        global $DB;
        return "The user with id {$this->userid} is deleted a event.";    
    }
    ...
    public static function get_name() {
        return get_string('eventsdeletedevent', 'local_learningtracks');
    }
