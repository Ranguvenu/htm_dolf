...
// $string['emailpasswordconfirmmaybesent'] = '<p>A message has been sent to your email address, which is registered in the system. If you did not receive the message, please contact technical support at the following e-mail: <a href="mailto:cs@fa.gov.sa">cs@fa.gov.sa</a></p>';
