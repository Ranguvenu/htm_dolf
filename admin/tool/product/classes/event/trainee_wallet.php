 ...
 */
namespace tool_product\event;

defined('MOODLE_INTERNAL') || die();

class trainee_wallet extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'trainee_wallet';
    }
    ...
    public function get_description() {
        ...
        return get_string('traineewalletupdate', 'tool_product'); 
