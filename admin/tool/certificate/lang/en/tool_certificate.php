...
$string['examtmpl'] = 'Certificate Exam template';
$string['examtmplbackground'] = 'Background image';
$string['examtmplawardedto'] = 'This certificate is awarded to';
$string['examtmplusernameen'] = 'English User Name';
$string['examtmplusernamear'] = 'Arabic User Name';
$string['examtmplforcompleting'] = 'For completing the exam';
$string['examtmplfullnameen'] = 'English Exam full name';
$string['examtmplfullnamear'] = 'Arabic Exam full name';
$string['examtmplawardedon'] = 'Awarded on';
$string['examtmplissueddate'] = 'Issued date';
$string['examtmplsignature'] = 'Signature';
$string['examtmpldirector'] = 'Exam Official';
$string['examtmplqrcode'] = 'QR Code';
$string['examtmplcode'] = 'Code';
$string['examtmplemployeeidnumber'] = 'Employee ID Number';
$string['examtmplexpirydatetxt'] = 'Expiry Date';
$string['examtmpliexpiryddate'] = 'Expiry date';

$string['examtmplusernameenlabel'] = 'Title One';
$string['examtmplusernamearlabel'] = 'Title Two';
$string['examtmplfullnameenlabel'] = 'Title Three';
$string['examtmplfullnamearlabel'] = 'Title Four';
$string['examtmplemployeeidnumberlabel'] = 'Title Five';
$string['examtmplcodelabel'] = 'Title Six';
$string['examtmplissueddatelabel'] = 'Title Seven';


$string['tptmpl'] = 'Certificate Training Program template';
$string['tptmplbackground'] = 'Background image';
$string['tptmplawardedto'] = 'This certificate is awarded to';
$string['tptmplusernameen'] = 'English User Name';
$string['tptmplusernamear'] = 'Arabic User Name';
$string['tptmplforcompleting'] = 'For completing the exam';
$string['tptmplfullnameen'] = 'English Training Program Full Name';
$string['tptmplfullnamear'] = 'Arabic Training Program full name';
$string['tptmplduration'] = 'Training Program Duration';
$string['tptmplemployeeidnumber'] = 'Employee ID Number';
$string['tptmplissueddate'] = 'Issued date';
$string['tptmplsignature'] = 'Signature';
$string['tptmpldirector'] = 'Training Official';
$string['tptmplqrcode'] = 'QR Code';
$string['tptmplcode'] = 'Code';
$string['tptmplexpirydatetxt'] = 'Expiry Date';
$string['tptmpliexpiryddate'] = 'Expiry date';

$string['tptmplusernameenlabel'] = 'Title One';
$string['tptmplusernamearlabel'] = 'Title Two';
$string['tptmplfullnameenlabel'] = 'Title Three';
$string['tptmplfullnamearlabel'] = 'Title Four';
$string['tptmplemployeeidnumberlabel'] = 'Title Five';
$string['tptmplcodelabel'] = 'Title Six';
$string['tptmplissueddatelabel'] = 'Title Seven';

$string['eventstmpl'] = 'Certificate Events template';
$string['eventstmplbackground'] = 'Background image';
$string['eventstmplawardedto'] = 'This certificate is awarded to';
$string['eventstmplforcompleting'] = 'For completing the exam';
$string['eventstmplawardedon'] = 'Awarded on';
$string['eventstmplissueddate'] = 'Issued date';
$string['eventstmplsignature'] = 'Signature';
$string['eventstmpldirector'] = 'Event Manager';
$string['eventstmplqrcode'] = 'QR Code';
$string['eventstmplcode'] = 'Code';
$string['eventstmplemployeeidnumber'] = 'Employee ID Number';
$string['eventstmplfullnameen'] = 'English Events full name';
$string['eventstmplfullnamear'] = 'Arabic Events full name';
$string['eventstmplusernameen'] = 'English User Name';
$string['eventstmplusernamear'] = 'Arabic User Name';
$string['eventstmplexpirydatetxt'] = 'Expiry Date';
$string['eventstmpliexpiryddate'] = 'Expiry date';

$string['eventstmplusernameenlabel'] = 'Title One';
$string['eventstmplusernamearlabel'] = 'Title Two';
$string['eventstmplfullnameenlabel'] = 'Title Three';
$string['eventstmplfullnamearlabel'] = 'Title Four';
$string['eventstmplemployeeidnumberlabel'] = 'Title Five';
$string['eventstmplcodelabel'] = 'Title Six';
$string['eventstmplissueddatelabel'] = 'Title Seven';

$string['ltrtmpl'] = 'Certificate Learning Tracks template';
$string['ltrtmplbackground'] = 'Background image';
$string['ltrtmplawardedto'] = 'This certificate is awarded to';
$string['ltrtmplforcompleting'] = 'For completing the learning Tracks';
$string['ltrtmplawardedon'] = 'Awarded on';
$string['ltrtmplissueddate'] = 'Issued date';
$string['ltrtmplsignature'] = 'Signature';
$string['ltrtmpldirector'] = 'Event Manager';
$string['ltrtmplqrcode'] = 'QR Code';
$string['ltrtmplcode'] = 'Code';
$string['ltrtmplemployeeidnumber'] = 'Employee ID Number';
$string['ltrtmplfullnameen'] = 'English Learning Track full name';
$string['ltrtmplfullnamear'] = 'Arabic Learning Track full name';
$string['ltrtmplusernameen'] = 'English User name';
$string['ltrtmplusernamear'] = 'Arabic User Name';
$string['ltrtmplexpirydatetxt'] = 'Expiry Date';
$string['ltrtmpliexpiryddate'] = 'Expiry date';

$string['ltrtmplusernameenlabel'] = 'Title One';
$string['ltrtmplusernamearlabel'] = 'Title Two';
$string['ltrtmplfullnameenlabel'] = 'Title Three';
$string['ltrtmplfullnamearlabel'] = 'Title Four';
$string['ltrtmplemployeeidnumberlabel'] = 'Title Five';
$string['ltrtmplcodelabel'] = 'Title Six';
$string['ltrtmplissueddatelabel'] = 'Title Seven';
$string['ltrtmplimageone'] = 'Image One';
$string['entity_type'] = 'Entity Type';
$string['entity_name'] = 'Entity Name';
$string['username'] = 'User Name';
$string['user_email'] = 'User Email';
$string['exp_date'] = 'Expiry Date';
$string['actions'] = 'Actions';
$string['trainingprogram'] = 'Training Program';
$string['exams'] = 'Exam';
$string['events'] = 'Event';
$string['learningtracks'] = 'Learning Track';
...
$string['selecttemplates'] = 'Select a template';
$string['issuecertificates_confirm'] = 'Are you sure you want to issue certificate for this users?';
$string['nousercompletionfound'] = 'No user was found to issue the certificate. The certificates have already been issued to all the users who have completed the exams.';
$string['usernotselected'] = 'No users are selected. Please select a user first..!';
$string['alert'] = 'Alert';
$string['singleissueconfirm'] = 'Are you sure you want to issue certificate for this user?';
$string['confirm_issueforselectedusers'] = 'Are you sure you want to issue certificate for the selected users?';
$string['confirm_issueforallusers'] = 'Are you sure you want to issue certificate for all users?';
$string['sure'] = 'Save';
