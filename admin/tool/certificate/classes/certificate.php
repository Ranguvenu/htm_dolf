...
use tool_certificate\certificates_list;
...
class certificate {
    ...
    public static function create_demo_template(): void {
        ...
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'freesans',
            ...
            'posx' => 44, 'posy' => 157, 'width' =>140, 'sequence' => 8, 'refpoint' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
    ...
    public static function create_exam_template(): void {
        global $CFG,$DB;
       $id=$DB->get_field('course_categories','id',array('idnumber'=>'exams'));
       if($id){
        ...
        // Create template.
        $templaterecord = [
            'name' => get_string('examtmpl', 'tool_certificate'),
        ...
        // Create template elements.
        $str = get_string('examtmplbackground', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'image',
            'data' => json_encode(['width' => 0, 'height' => 0, 'isbackground' => true]), 'sequence' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
        self::create_custom_element_file($context->id,$element->get('id'), "{$CFG->dirroot}/{$CFG->admin}/tool/certificate/pix/Certificate_Exam.jpg");


        $str = get_string('examtmplusernameenlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'data' => 'The Financial Academy hereby certifies that',
            'font' => 'helveticab', 'fontsize' => 20, 'colour' => '#808080', 'posx' => 13, 'posy' => 67, 'sequence' => 1,
            'refpoint' => 0,'width' =>150];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplusernamearlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'data' => 'تشهد الأكاديمية المالية بأن',
            'font' => 'helveticaneueltarabicb', 'fontsize' => 20, 'colour' => '#808080', 'posx' => 284, 'posy' => 67, 'sequence' => 2,
            'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

         $str = get_string('examtmplusernameen', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'data' => 'fullname',
            'font' => 'helveticab', 'fontsize' => 20, 'colour' => '#000000', 'posx' => 13, 'posy' => 85, 'sequence' => 3,
            'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplusernamear', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'data' => 'arabicfullname',
            'font' => 'helveticaneueltarabicb', 'fontsize' => 20, 'colour' => '#000000', 'posx' => 284, 'posy' => 85, 'sequence' => 4,
            'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();


        $str = get_string('examtmplfullnameenlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'font' => 'helveticab',
            'fontsize' => 15, 'data' => 'has successfully passed', 'colour' => '#A9A9A9', 'posx' => 13,
            'posy' => 105, 'sequence' => 5, 'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplfullnamearlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 15, 'data' => 'قد أتم(ت) بنجاح', 'colour' => '#A9A9A9', 'posx' => 284,
            'posy' => 105, 'sequence' => 6, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplfullnameen', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'modulename', 'font' => 'helveticab',
            'fontsize' => 20, 'data' => json_encode(['modulenametype' => 1]), 'colour' => '#004c98', 'posx' => 13,
            'posy' => 115, 'sequence' => 7, 'refpoint' => 0,'width' =>135];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplfullnamear', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'modulename', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 20, 'data' => json_encode(['modulenametype' => 2]), 'colour' => '#004c98', 'posx' => 284,
            'posy' => 115, 'sequence' => 8, 'refpoint' => 2,'width' =>135];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplemployeeidnumber', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => 'idnumber', 'colour' => '#000000', 'posx' => 284,
            'posy' => 134, 'sequence' => 9, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplissueddate', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'date', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => json_encode(['dateitem' => -1, 'dateformat' => 'strftimedatefullshortwleadingzero']), 'colour' => '#000000',
            'posx' => 284, 'posy' => 152, 'sequence' => 10, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplcode', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => json_encode(['display' => 1]), 'colour' => '#000000',
            'posx' => 284, 'posy' => 143, 'width' =>140, 'sequence' => 11, 'refpoint' => 2];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('examtmplqrcode', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'freesans',
            'fontsize' => 12, 'data' => json_encode(['display' => 4]), 'colour' => '#000000',
            'posx' => 284, 'posy' => 186, 'width' => 20, 'sequence' => 12, 'refpoint' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();


    }
    public static function create_trainingprogram_template(): void {
        global $CFG,$DB;
       $id=$DB->get_field('course_categories','id',array('idnumber'=>'trainingprogram'));
       if($id){
        $context = \context_coursecat::instance($id);
       }
       else{       
        ...
        // Create template.
        $templaterecord = [
            'name' => get_string('tptmpl', 'tool_certificate'),
            'contextid' => $context->id,
            'shared' => 1,
        ];
        $template = \tool_certificate\template::create((object)$templaterecord);
        ...
        // Create template elements.
        $str = get_string('tptmplbackground', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'image',
            'data' => json_encode(['width' => 0, 'height' => 0, 'isbackground' => true]), 'sequence' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
        self::create_custom_element_file($context->id,$element->get('id'), "{$CFG->dirroot}/{$CFG->admin}/tool/certificate/pix/Certificate_Training_Program.jpg");

     
        $str = get_string('tptmplusernameenlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'data' => 'The Financial Academy hereby certifies that',
            'font' => 'helveticab', 'fontsize' => 20, 'colour' => '#808080', 'posx' => 13, 'posy' => 67, 'sequence' => 1,
            'refpoint' => 0,'width' =>150];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('tptmplusernamearlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'data' => 'تشهد الأكاديمية المالية بأن',
            'font' => 'helveticaneueltarabicb', 'fontsize' => 20, 'colour' => '#808080', 'posx' => 284, 'posy' => 67, 'sequence' => 2,
            'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
         ...
         $str = get_string('tptmplusernameen', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'data' => 'fullname',
            'font' => 'helveticab', 'fontsize' => 20, 'colour' => '#000000', 'posx' => 13, 'posy' => 85, 'sequence' => 3,
            'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('tptmplusernamear', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'data' => 'arabicfullname',
            'font' => 'helveticaneueltarabicb', 'fontsize' => 20, 'colour' => '#000000', 'posx' => 284, 'posy' => 85, 'sequence' => 4,
            'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('tptmplfullnameenlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'font' => 'helveticab',
            'fontsize' => 15, 'data' => 'has successfully passed', 'colour' => '#A9A9A9', 'posx' => 13,
            'posy' => 105, 'sequence' => 5, 'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('tptmplfullnamearlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 15, 'data' => 'قد أتم(ت) بنجاح', 'colour' => '#A9A9A9', 'posx' => 284,
            'posy' => 105, 'sequence' => 6, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('tptmplfullnameen', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'modulename', 'font' => 'helveticab',
            'fontsize' => 20, 'data' => json_encode(['modulenametype' => 1]), 'colour' => '#004c98', 'posx' => 13,
            'posy' => 115, 'sequence' => 7, 'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('tptmplfullnamear', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'modulename', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 20, 'data' => json_encode(['modulenametype' => 2]), 'colour' => '#004c98', 'posx' => 284,
            'posy' => 115, 'sequence' => 8, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('tptmplemployeeidnumber', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 11, 'data' => 'idnumber', 'colour' => '#000000', 'posx' => 286,
            'posy' => 155, 'sequence' => 9, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('tptmplissueddate', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'date', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 11, 'data' => json_encode(['dateitem' => -1, 'dateformat' => 'strftimedatefullshortwleadingzero']), 'colour' => '#000000',
            'posx' => 286, 'posy' => 162, 'sequence' => 10, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('tptmplcode', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 11, 'data' => json_encode(['display' => 1]), 'colour' => '#000000',
            'posx' => 286, 'posy' => 169, 'width' =>140, 'sequence' => 11, 'refpoint' => 2];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('tptmplqrcode', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'freesans',
            'fontsize' => 12, 'data' => json_encode(['display' => 4]), 'colour' => '#000000',
            'posx' => 284, 'posy' => 186, 'width' => 20, 'sequence' => 12, 'refpoint' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('tptmplduration', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'moduleduration', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 11, 'data' => json_encode(['dateitem' => -1, 'dateformat' => 'strftimedatefullshortwleadingzero']), 'colour' => '#000000',
            'posx' => 286, 'posy' => 148, 'width' => 140, 'sequence' => 13, 'refpoint' => 2];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

    }
    public static function create_events_template(): void {
        global $CFG,$DB;
        
       $id=$DB->get_field('course_categories','id',array('idnumber'=>'events'));
              if($id){
        $context = \context_coursecat::instance($id);
       }
       else{       
        ...
        // Create template.
        $templaterecord = [
            'name' => get_string('eventstmpl', 'tool_certificate'),
            'contextid' => $context->id,
            'shared' => 1,
        ];
        $template = \tool_certificate\template::create((object)$templaterecord);
        ...
        // Create template elements.
        $str = get_string('eventstmplbackground', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'image',
            'data' => json_encode(['width' => 0, 'height' => 0, 'isbackground' => true]), 'sequence' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
        self::create_custom_element_file($context->id,$element->get('id'), "{$CFG->dirroot}/{$CFG->admin}/tool/certificate/pix/Certificate_Event.jpg");

        $str = get_string('eventstmplusernameenlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'data' => 'The Financial Academy hereby certifies that',
            'font' => 'helveticab', 'fontsize' => 20, 'colour' => '#808080', 'posx' => 13, 'posy' => 67, 'sequence' => 1,
            'refpoint' => 0,'width' =>150];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('eventstmplusernamearlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'data' => 'تشهد الأكاديمية المالية بأن',
            'font' => 'helveticaneueltarabicb', 'fontsize' => 20, 'colour' => '#808080', 'posx' => 284, 'posy' => 67, 'sequence' => 2,
            'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
         ...
         $str = get_string('eventstmplusernameen', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'data' => 'fullname',
            'font' => 'helveticab', 'fontsize' => 20, 'colour' => '#000000', 'posx' => 13, 'posy' => 85, 'sequence' => 3,
            'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('eventstmplusernamear', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'data' => 'arabicfullname',
            'font' => 'helveticaneueltarabicb', 'fontsize' => 20, 'colour' => '#000000', 'posx' => 284, 'posy' => 85, 'sequence' => 4,
            'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('eventstmplfullnameenlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'font' => 'helveticab',
            'fontsize' => 15, 'data' => 'has attended', 'colour' => '#A9A9A9', 'posx' => 13,
            'posy' => 105, 'sequence' => 5, 'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('eventstmplfullnamearlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 15, 'data' => 'قد حضر(ت)', 'colour' => '#A9A9A9', 'posx' => 284,
            'posy' => 105, 'sequence' => 6, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('eventstmplfullnameen', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'modulename', 'font' => 'helveticab',
            'fontsize' => 20, 'data' => json_encode(['modulenametype' => 1]), 'colour' => '#004c98', 'posx' => 13,
            'posy' => 115, 'sequence' => 7, 'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('eventstmplfullnamear', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'modulename', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 20, 'data' => json_encode(['modulenametype' => 2]), 'colour' => '#004c98', 'posx' => 284,
            'posy' => 115, 'sequence' => 8, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('eventstmplemployeeidnumber', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => 'idnumber', 'colour' => '#000000', 'posx' => 284,
            'posy' => 134, 'sequence' => 9, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('eventstmplissueddate', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'date', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => json_encode(['dateitem' => -1, 'dateformat' => 'strftimedatefullshortwleadingzero']), 'colour' => '#000000',
            'posx' => 284, 'posy' => 152, 'sequence' => 10, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('eventstmplcode', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => json_encode(['display' => 1]), 'colour' => '#000000',
            'posx' => 284, 'posy' => 143, 'width' =>140, 'sequence' => 11, 'refpoint' => 2];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('eventstmplqrcode', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'freesans',
            'fontsize' => 12, 'data' => json_encode(['display' => 4]), 'colour' => '#000000',
            'posx' => 284, 'posy' => 186, 'width' => 20, 'sequence' => 12, 'refpoint' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
    ...
    public static function create_learningtracks_template(): void {
        global $CFG,$DB;
        
       $id=$DB->get_field('course_categories','id',array('idnumber'=>'learningtracks'));
              if($id){
        $context = \context_coursecat::instance($id);
       }
       else{       
        ...
        // Create template.
        $templaterecord = [
            'name' => get_string('ltrtmpl', 'tool_certificate'),
            'contextid' => $context->id,
            'shared' => 1,
        ];
        $template = \tool_certificate\template::create((object)$templaterecord);
        ...
        // Create template elements.
        $str = get_string('ltrtmplbackground', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'image',
            'data' => json_encode(['width' => 0, 'height' => 0, 'isbackground' => true]), 'sequence' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
        self::create_custom_element_file($context->id,$element->get('id'), "{$CFG->dirroot}/{$CFG->admin}/tool/certificate/pix/Certificate_Qualified.jpg");
  
        $str = get_string('ltrtmplusernameenlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'data' => 'The Financial Academy hereby certifies that',
            'font' => 'helveticab', 'fontsize' => 20, 'colour' => '#808080', 'posx' => 13, 'posy' => 67, 'sequence' => 1,
            'refpoint' => 0,'width' =>150];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('ltrtmplusernamearlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'data' => 'تشهد الأكاديمية المالية بأن',
            'font' => 'helveticaneueltarabicb', 'fontsize' => 20, 'colour' => '#808080', 'posx' => 284, 'posy' => 67, 'sequence' => 2,
            'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
         ...
         $str = get_string('ltrtmplusernameen', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'data' => 'fullname',
            'font' => 'helveticab', 'fontsize' => 20, 'colour' => '#000000', 'posx' => 13, 'posy' => 85, 'sequence' => 3,
            'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('ltrtmplusernamear', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'data' => 'arabicfullname',
            'font' => 'helveticaneueltarabicb', 'fontsize' => 20, 'colour' => '#000000', 'posx' => 284, 'posy' => 85, 'sequence' => 4,
            'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        $str = get_string('ltrtmplfullnameenlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'font' => 'helveticab',
            'fontsize' => 15, 'data' => 'has successfully passed', 'colour' => '#A9A9A9', 'posx' => 13,
            'posy' => 100, 'sequence' => 5, 'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('ltrtmplfullnamearlabel', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'text', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 15, 'data' => 'قد أتم(ت) بنجاح', 'colour' => '#A9A9A9', 'posx' => 284,
            'posy' => 100, 'sequence' => 6, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('ltrtmplfullnameen', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'modulename', 'font' => 'helveticab',
            'fontsize' => 20, 'data' => json_encode(['modulenametype' => 1]), 'colour' => '#004c98', 'posx' => 13,
            'posy' => 110, 'sequence' => 7, 'refpoint' => 0,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('ltrtmplfullnamear', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'modulename', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 20, 'data' => json_encode(['modulenametype' => 2]), 'colour' => '#004c98', 'posx' => 284,
            'posy' => 110, 'sequence' => 8, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('ltrtmplemployeeidnumber', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'userfield', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => 'idnumber', 'colour' => '#000000', 'posx' => 284,
            'posy' => 145, 'sequence' => 9, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('ltrtmplissueddate', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'date', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => json_encode(['dateitem' => -1, 'dateformat' => 'strftimedatefullshortwleadingzero']), 'colour' => '#000000',
            'posx' => 284, 'posy' => 165, 'sequence' => 10, 'refpoint' => 2,'width' =>140];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('ltrtmplcode', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'helveticaneueltarabicb',
            'fontsize' => 12, 'data' => json_encode(['display' => 1]), 'colour' => '#000000',
            'posx' => 284, 'posy' => 155, 'width' =>140, 'sequence' => 11, 'refpoint' => 2];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();

        $str = get_string('ltrtmplqrcode', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'code', 'font' => 'freesans',
            'fontsize' => 12, 'data' => json_encode(['display' => 4]), 'colour' => '#000000',
            'posx' => 284, 'posy' => 186, 'width' => 20, 'sequence' => 12, 'refpoint' => 1];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        ...
        // Create template elements.
        $str = get_string('ltrtmplimageone', 'tool_certificate');
        $elementrecord = ['pageid' => $page->get_id(), 'name' => $str, 'element' => 'image',
            'data' => json_encode(['width' => 0, 'height' => 0, 'isbackground' => false]), 'sequence' => 13,'posx' => 188, 'posy' => 123];
        $element = new \tool_certificate\persistent\element(0, (object)$elementrecord);
        $element->save();
        self::create_custom_element_file($context->id,$element->get('id'), "{$CFG->dirroot}/{$CFG->admin}/tool/certificate/pix/Certificate_Qualified_One.png");
     ...
     * @param string $filepath
     */
    private static function create_custom_element_file(int $contextid,int $elementid, string $filepath): void {
        $fs = get_file_storage();
     ...
     */
    public static function add_expirydate_to_form(MoodleQuickForm &$mform, $page = ''): void {
        $expirydateoptions = [
        ...
        if ($page) {
            $mform->hideIf('expirydateformgroup', 'expirydatetype', 'eq', self::DATE_EXPIRATION_NEVER);
        }
    }
     ...
     * 
     */
    public static function get_templates_for_dropdown() {
        global $DB;
        $sql = "SELECT c.id, c.name AS name, c.contextid, c.shared, ctx.id AS coursecategory, ctx.path, ctx.depth,
                ...
                LEFT JOIN {course_categories} coursecat ON coursecat.id = ctx.instanceid
                ORDER BY c.id DESC";
