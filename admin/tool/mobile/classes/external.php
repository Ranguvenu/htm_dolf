...
class external extends external_api {
    ...
    public static function get_config($section = '') {
        ...
        $result['settings'][] = array(
            'name' =>'tool_product_tax_percentage',
            'value' => $DB->get_field('config_plugins','value',['plugin'=>'tool_product','name'=>'tax_percentage'])
        );
        $result['settings'][] = array(
            'name' => 'tool_product_max_discount_percentage',
            'value' => $DB->get_field('config_plugins','value',['plugin'=>'tool_product','name'=>'max_discount_percentage'])
        );
