...
class get_config_for_js extends external_api {
    ...
    /**
     * Returns the config values required by the telr JavaScript SDK.
     *
    ...
    public static function execute(string $component, string $paymentarea, int $itemid): array {
        ...
        $config = helper::get_gateway_configuration($component, $paymentarea, $itemid, 'telr');
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'clientid' => new external_value(PARAM_TEXT, 'telr client ID'),
