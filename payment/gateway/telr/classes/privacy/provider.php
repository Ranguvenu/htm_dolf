...
/**
 * Privacy Subsystem implementation for paygw_telr.
 *
 * @package    paygw_telr
 * @category   privacy
 */

namespace paygw_telr\privacy;

use core_payment\privacy\paygw_provider;
use core_privacy\local\request\writer;

/**
 * Privacy Subsystem implementation for 
paygw_telr.
 *
...
class provider implements \core_privacy\local\metadata\null_provider, paygw_provider {
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment) {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_telr');
        $record = $DB->get_record('paygw_telr', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams) {
        ...
        $DB->delete_records_select('paygw_telr', "paymentid IN ({$paymentsql})", $paymentparams);
    }
}
