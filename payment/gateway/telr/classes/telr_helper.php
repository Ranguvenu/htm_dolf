...
/**
 * Contains helper class to work with telr REST API.
 *
...
class telr_helper {
     ...
     * @param string $secret telr secret.
    ...
    public function __construct(string $clientid, string $secret, bool $sandbox) {
        ...
        $this->secret = $secret;
        $this->baseurl = $sandbox ? 'https://api.sandbox.telr.com' : 'https://api.telr.com';
     ...
     *
     * @param string $authorizationid The telr-generated ID for the authorized payment to capture.
    ...
    /**
     * Captures order details from telr.
     *
    ...
    /**
     * Request for telr REST oath bearer token.
     *
     * @return string
     */
