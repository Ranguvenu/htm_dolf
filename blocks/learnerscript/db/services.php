...
$services = array(
    'Reports' => array( 
        'functions' => array ('block_learnerscript_generate_plotgraph'),
        'requiredcapability' => '',               
        'restrictedusers' => 0,                                           
        'enabled' => 1,                                                    
        'shortname' =>  'reports',     
    ...
    'Get Reports' => array( 
        'functions' => array ('block_learnerscript_get_reports'),
        'requiredcapability' => '',               
        'restrictedusers' => 0,                                           
        'enabled' => 1,                                                    
        'shortname' =>  'getreports',     
        'downloadfiles' => 0,    
        'uploadfiles'  => 0    
    ),

    'Reports List' => array( 
        'functions' => array ('block_learnerscript_reportslist'),
        'requiredcapability' => '',               
        'restrictedusers' => 0,                                           
        'enabled' => 1,                                                    
        'shortname' =>  'reportslist',     
        'downloadfiles' => 0,    
        'uploadfiles'  => 0    
    ),
);
...
'block_learnerscript_filteridnumber' => array(
        'classname' => 'block_learnerscript_external',
        'methodname' => 'filteridnumber',
        'classpath' => 'blocks/learnerscript/externallib.php',
        'description' => 'Filter Identity',
        'ajax' => true
    ),
'block_learnerscript_reportslist' => array(
    'classname' => 'block_learnerscript_external',
    'methodname' => 'reportslist',
    'classpath' => 'blocks/learnerscript/externallib.php',
...
'block_learnerscript_get_reports' => array(
    'classname' => 'block_learnerscript_external',
    'methodname' => 'get_reports',
    'classpath' => 'blocks/learnerscript/externallib.php',
    'description' => 'case get_reports',
    'ajax' => true,
    'services' => array(MOODLE_OFFICIAL_MOBILE_SERVICE),
