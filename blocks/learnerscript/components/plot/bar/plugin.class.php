...
class plugin_bar extends pluginbase {
    ...
    function init() {
        ...
        $this->form = true;
        $this->ordering = true;
        $this->reporttypes = array('sql', 'trainingprograms', 'exams', 'offerings', 'events', 'competencies', 'cpd', 'halls', 'learningtrackinfo', 'organization', 'questionbankinfo', 'prepostexams', 'examgrades');
    }
