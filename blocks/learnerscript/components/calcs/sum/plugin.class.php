...
class plugin_sum extends pluginbase {
    ...
    function init() {
        ...
        $this->reporttypes = array('courses', 'users', 'timeline', 'categories','assignment','courses', 'coursesoverview', 'gradedactivity', 'myassignments', 'myquizs', 'quizzes','scorm', 'useractivities', 'userassignments', 'usercourses', 'userquizzes', 'usersresources', 'usersscorm', 'courseactivities', 'myscorm','revenue','transaction', 'offerings');
    }
