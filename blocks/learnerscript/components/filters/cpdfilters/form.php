...
class cpdfilters_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'crformheader', get_string('cpdfilters', 'block_learnerscript'), '');
        ...
        unset($tpcolumns['validation']);
        unset($tpcolumns['hourscreated']);
