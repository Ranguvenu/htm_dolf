...
class offeringfilters_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'crformheader', get_string('offeringfilters', 'block_learnerscript'), '');

        $columns = $DB->get_columns('tp_offerings');
        ...
        unset($tpcolumns['time']);
        unset($tpcolumns['endtime']);
        unset($tpcolumns['duration']);
        unset($tpcolumns['meetingid']);
        unset($tpcolumns['halllocation']);
        unset($tpcolumns['prequiz']);
        unset($tpcolumns['postquiz']);
        unset($tpcolumns['availableseats']);
