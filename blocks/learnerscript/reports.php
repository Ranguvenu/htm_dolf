...
$roleshortname = optional_param('role', '', PARAM_RAW);
...
echo '<div style="float:right;"><a class="btn linkbtn btn-primary" href="' . $CFG->wwwroot . '/blocks/reportdashboard/dashboard.php?dashboardurl=Facademy&role='.$_SESSION['role'].'&contextlevel='.$_SESSION['ls_contextlevel'].'">' . (get_string('dashboard', 'block_reportdashboard')) . '</a></div>';
