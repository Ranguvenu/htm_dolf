        ...
        return {
            ...
            addblocks_to_dashboard: function() {
                ...
                var promise = Ajax.call([{
                 ...
                 var dashboardstring=Str.get_string('addblockstodashboard','block_reportdashboard');
                promise[0].done(function(response) {
                      
                    dashboardstring.done(function(title) {
            ...
            addtiles_to_dashboard: function() {
                ...
                var tilesstring=Str.get_string('addtilestodashboard','block_reportdashboard');
                 promise[0].done(function(response) {
                    tilesstring.done(function(title) {
