...
class reportselect_form extends moodleform {
    ...
    public function definition() {
        ...
        $textgroup[] = &$mform->createElement('static', 'reportnametext', '',
            '<span class="dashboard_reportname"><b>'.get_string('reportname','block_reportdashboard').'</b></span>');
        $textgroup[] = &$mform->createElement('static', 'reporttypetext', '',
            '<span class="widget_reporttype"><b>'.get_string('reporttype','block_reportdashboard').'</b></span>');
        $textgroup[] = &$mform->createElement('static', 'wieghttext', '',
            '<span class="widget_position"><b>'.get_string('position','block_reportdashboard').'</b></span>');
