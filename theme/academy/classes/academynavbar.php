...
/**
 * Creates a navbar for academy that allows easy control of the navbar items.
 *
 * @package    theme_academy
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class academynavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_academy();
    }

    /**
     * Prepares the navigation nodes for use with academy.
     */
    protected function prepare_nodes_for_academy(): void {
        global $PAGE;
    ...
    /**
     * Get all the academynavbaritem elements.
     *
     * @return academynavbaritem[] Academy navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this academy navbar
     */
    ...
    /**
     * Remove a academynavbaritem from the academy navbar.
     *
     * @param  string|int $itemkey An identifier for the academynavbaritem
     * @param  int|null $itemtype An additional type identifier for the academynavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the academynavbaritem.
     */
