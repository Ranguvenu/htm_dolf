 ...
 * theme Academy when working with Bootstrap 4 alpha. We do not recommend
...
class autoprefixer {
    ...
    public function __construct(Document $tree) {
        debugging('theme_academy\autoprefixer() is deprecated. Required prefixes for Bootstrap ' .
            'are now in theme/academy/scss/moodle/prefixes.scss', DEBUG_DEVELOPER);
        $this->tree = $tree;
