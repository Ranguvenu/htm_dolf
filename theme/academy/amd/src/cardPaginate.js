 ...
 *
 * @module    theme_academy/cardPaginate
...
define(
    [
        ...
        'core/notification',
        'core/templates',
        'theme_academy/paged_content_factory'
    ],
    function(
        $,
        Ajax,
            ...
            .then(function(response) {
                ...
                if (records.length) {
                    ...
                    if(response.nodata){
						...
						var name=Str.get_string('no_data_available', 'theme_academy');
                        ...
                        return Templates.render('theme_academy/no-data', {name:s});
						});
                    }
