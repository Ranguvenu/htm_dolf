...
// The jQuery module is only used for interacting with Academyrap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
    if (button.hasAttribute('data-original-title')) {
        // The jQuery is still used in Academyrap 4. It can we removed when MDL-71979 is integrated.
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_academy/drawers:show}
     * @property {String} drawerShown See {@link event:theme_academy/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_academy/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_academy/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_academy/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_academy/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_academy/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_academy/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_academy/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_academy/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_academy/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_academy/drawers:hidden',
    };
     ...
     * @returns {module:theme_academy/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_academy/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_academy/drawers:close');
     ...
     *
     * @param {module:theme_academy/drawers} comparisonInstance
     */
